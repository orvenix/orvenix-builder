    ...
    return NextResponse.json(
      {
        ...
        message:
          error instanceof Error
            ? error.message
            : "El e-commerce no está incluido en tu plan.",
      },
      { status: 403 },
    )
  }
    ...
    return NextResponse.json(
      {
        error: "EXPERIMENTS_NOT_READY",
        message:
          "Hace falta aplicar el schema nuevo para habilitar experimentos.",
      },
      { status: 503 },
    )
  }
      ...
      return NextResponse.json(
        {
          ...
          upgradeUrl: "/precios?upgrade=experiments",
        },
        { status: 403 },
      )
    }
