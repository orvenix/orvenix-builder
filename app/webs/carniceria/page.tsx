        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/webs/carniceria/cortes" className="btn-primary px-8 py-4">
                Ver cortes <ArrowRight size={18} />
              </Link>
              <Link href="/webs/carniceria/pedidos" className="bg-amber-500 hover:bg-amber-600 text-white font-bold px-8 py-4 rounded-xl transition-all inline-flex items-center gap-2">
                Hacer pedido
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 bg-amber-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {categorias.map(cat => (
              <Link key={cat.slug} href={`/webs/carniceria/cortes#${cat.slug}`} className="bg-white rounded-2xl p-6 text-center border-2 border-transparent hover:border-meat hover:shadow-lg transition-all group">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link href="/webs/carniceria/cortes" className="hidden md:flex items-center gap-1 text-meat font-semibold text-sm hover:gap-2 transition-all">
            ...
            <div className="absolute inset-0 bg-dark/70 flex items-center">
              <div className="max-w-7xl mx-auto px-8 md:px-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 w-full">
                ...
                <div className="flex gap-3 flex-shrink-0">
                  <Link href="/webs/carniceria/pedidos" className="btn-primary">Hacer pedido</Link>
