...
const navLinks = [
  { href: '/webs/carniceria/cortes', label: 'Nuestros cortes' },
  { href: '/webs/carniceria/pedidos', label: 'Hacer pedido' },
  { href: '/webs/carniceria/galeria', label: 'Galería' },
  { href: '/webs/carniceria/nosotros', label: 'Nosotros' },
  { href: '/webs/carniceria/contacto', label: 'Contacto' },
]
    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/webs/carniceria" className="flex items-center gap-2.5">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link href="/webs/carniceria/pedidos" className="btn-primary text-sm py-2.5">
