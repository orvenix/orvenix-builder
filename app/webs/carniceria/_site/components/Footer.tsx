        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="p-2 bg-white/5 rounded-lg hover:bg-meat/40 transition-colors"><Mail size={15} /></a>
              <a href="#" className="p-2 bg-white/5 rounded-lg hover:bg-meat/40 transition-colors"><Globe size={15} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['Res premium', 'Cerdo artesanal', 'Cordero', 'Pollo de campo', 'Embutidos propios', 'Marinados'].map(i => (
                <li key={i}><Link href="/webs/carniceria/cortes" className="hover:text-amber-400 transition-colors">{i}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[{href:'/webs/carniceria/pedidos',l:'Hacer pedido'},{href:'/webs/carniceria/galeria',l:'Galería'},{href:'/webs/carniceria/nosotros',l:'Nosotros'},{href:'/webs/carniceria/contacto',l:'Contacto'}].map(({href,l})=>(
