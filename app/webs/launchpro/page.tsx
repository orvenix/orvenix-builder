      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-14">
            <Link href="/webs/launchpro#pricing" className="btn-primary px-8 py-4 text-base">
              Empezar gratis <ArrowRight size={18} />
            </Link>
            <Link href="/webs/launchpro#features" className="btn-outline px-8 py-4 text-base">
              Ver demo en vivo
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {plans.map(plan => (
              <div key={plan.name} className={`glass-card p-8 flex flex-col ${plan.popular ? 'border-brand-500/60 ring-1 ring-brand-500/30 relative' : ''}`}>
                ...
                <Link
                  href={plan.price === 0 ? "/webs/launchpro#pricing" : "/webs/launchpro/contacto"}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="glass-card p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <Link href="/webs/launchpro#pricing" className="btn-primary px-10 py-4 text-base">
