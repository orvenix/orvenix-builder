...
const navLinks = [
  { href: '/webs/jugueteria/catalogo', label: 'Catálogo' },
  { href: '/webs/jugueteria/catalogo/0-3', label: '0–3 años' },
  { href: '/webs/jugueteria/catalogo/4-8', label: '4–8 años' },
  { href: '/webs/jugueteria/catalogo/9-mas', label: '9+ años' },
  { href: '/webs/jugueteria/nosotros', label: 'Nosotros' },
]
    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/webs/jugueteria" className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/webs/jugueteria/catalogo" className="relative p-2 text-gray-700 hover:text-blue-600">
