...
import { categorias, juguetes, badgeColors } from '@/app/webs/jugueteria/_site/lib/data'
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/webs/jugueteria/catalogo" className="bg-white text-blue-600 font-black px-8 py-4 rounded-2xl hover:bg-blue-50 transition-all inline-flex items-center gap-2 text-base shadow-lg">
                  Explorar juguetes <ArrowRight size={18} />
                </Link>
                <Link href="/webs/jugueteria/catalogo/educativos" className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-black px-8 py-4 rounded-2xl transition-all inline-flex items-center gap-2 text-base shadow-lg">
                  🔬 Educativos
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {categorias.map(cat => (
              <Link
                key={cat.slug}
                href={`/webs/jugueteria/catalogo/${cat.slug}`}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link href="/webs/jugueteria/catalogo" className="hidden md:flex items-center gap-1 text-blue-600 font-bold text-sm hover:gap-2 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-white flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-shrink-0">
              <Link href="/webs/jugueteria/catalogo/educativos" className="bg-white text-blue-600 font-black px-8 py-4 rounded-2xl hover:bg-blue-50 transition-all inline-flex items-center gap-2 text-base">
