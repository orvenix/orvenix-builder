    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            <div key={`${product.id}-${size}`} className="bg-white rounded-2xl border border-gray-100 p-4 flex gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-start">
                  <div>
                    <Link href={`/webs/vistamoda/tienda/${product.slug}`} className="font-semibold text-dark hover:text-brand-600 text-sm line-clamp-2">
                      {product.name}
                    </Link>
          ...
          <Link href="/webs/vistamoda/tienda" className="flex items-center gap-2 text-brand-600 font-medium text-sm mt-4 hover:gap-3 transition-all">
            ← Continuar comprando
          </Link>
        </div>
