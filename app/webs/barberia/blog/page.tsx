...
const cats = ["Todos", "Estilo", "Grooming", "Productos", "Cultura"]

export default function BarberiaBlog() {
    ...
    <div className="min-h-screen bg-[#0c0906]">
      <section className="relative py-24 overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-900/20 border border-amber-700/25 text-amber-400 text-xs mb-6">Del maestro a ti</div>
          <h1 className="text-5xl md:text-6xl font-black mb-6">
            <span className="text-white">Blog de</span>{" "}
            <span className="bg-gradient-to-r from-amber-400 to-stone-400 bg-clip-text text-transparent italic">grooming</span>
          </h1>
          <p className="text-white/35 max-w-xl mx-auto">Consejos de estilo, cuidado y cultura barbera. Escrito por maestros con décadas de experiencia.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#080604]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <p className="text-white/35 mb-6 italic">El mejor tip de estilo es un buen corte.</p>
