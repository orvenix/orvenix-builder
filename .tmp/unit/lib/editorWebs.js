...
exports.DEFAULT_STARTER_WEB_ID = exports.WEB_EDITOR_TREES = exports.WEB_LABELS = exports.WEB_IDS = void 0;
exports.isEditorWebId = isEditorWebId;
exports.getEditorTreeForWeb = getEditorTreeForWeb;
exports.getDefaultStarterEditorTree = getDefaultStarterEditorTree;
const starterTree_1 = require("@/lib/starterTree");
exports.WEB_IDS = [
    "ai-dashboard",
    "crm",
    "ecommerce",
...
function isEditorWebId(value) {
    return exports.WEB_IDS.includes(value);
}
exports.WEB_LABELS = {
...
function createPublicPageTree({ id, badge, title, copy, cta, image, background, text, muted, accent, servicesTitle, servicesCopy, proofTitle, proofCopy, }) {
...
exports.WEB_EDITOR_TREES = {
    "ai-dashboard": {
        ...
        nodes: {
            ...
            "ai-dashboard-copy": {
                ...
                type: "text",
                props: {
                    content: "Dashboard real del vertical de analytics con KPI cards, revenue charts y actividad operativa.",
                    size: "lg",
                    color: "#cbd5e1",
                    align: "left",
                    maxWidth: "lg",
    ...
    crm: {
        ...
        nodes: {
            ...
            "crm-copy": {
                ...
                type: "text",
                props: {
                    content: "Editor cargado con los módulos reales del CRM: métricas, tabla de contactos y pipeline de oportunidades.",
                    size: "lg",
                    color: "#475569",
                    align: "left",
                    maxWidth: "lg",
    ...
    ecommerce: {
        ...
        nodes: {
            ...
            "ecommerce-copy": {
                ...
                type: "text",
                props: {
                    content: "Canvas inicial con los componentes reales del e-commerce: stats, catálogo y tabla de pedidos.",
                    size: "lg",
                    color: "#6b7280",
                    align: "left",
                    maxWidth: "lg",
    ...
    "project-manager": {
        ...
        nodes: {
            ...
            "pm-copy": {
                ...
                type: "text",
                props: {
                    content: "Editor con las vistas reales del product manager: lista agrupada por estado y tablero kanban.",
                    size: "lg",
                    color: "#d1fae5",
                    align: "left",
                    maxWidth: "lg",
    ...
    finance: {
        ...
        nodes: {
            ...
            "finance-copy": {
                ...
                type: "text",
                props: {
                    content: "Editor cargado con los módulos reales de finanzas: KPIs, distribución de portfolio y tabla de transacciones.",
                    size: "lg",
                    color: "#d1fae5",
                    align: "left",
                    maxWidth: "lg",
    ...
    hr: {
        ...
        nodes: {
            ...
            "hr-copy": {
                ...
                type: "text",
                props: {
                    content: "Editor con los módulos reales de RRHH: KPIs, tabla de empleados y pipeline de reclutamiento.",
                    size: "lg",
                    color: "#fde68a",
                    align: "left",
                    maxWidth: "lg",
    ...
    devops: {
        ...
        nodes: {
            ...
            "devops-copy": {
                ...
                type: "text",
                props: {
                    content: "Editor con la estructura real de observabilidad: servidores, alertas y estado de microservicios.",
                    size: "lg",
                    color: "#cffafe",
                    align: "left",
                    maxWidth: "lg",
    ...
    tienda: {
        ...
        nodes: {
            ...
            "tienda-copy": {
                ...
                type: "text",
                props: {
                    content: "Canvas inicial para una tienda editable con hero comercial, catálogo de productos, pedidos y estructura de checkout.",
                    size: "lg",
                    color: "#57534e",
                    align: "left",
                    maxWidth: "lg",
    ...
    "servicios-locales": {
        ...
        nodes: {
            ...
            "servicios-locales-copy": {
                ...
                type: "text",
                props: {
                    content: "Base editable para negocios locales con hero, servicios, zonas de cobertura, proceso, resenas, FAQ y CTA a WhatsApp o agenda.",
                    size: "lg",
                    color: "#475569",
                    align: "left",
                    maxWidth: "lg",
    ...
    arquitectura: createPublicPageTree({
        ...
        copy: "Plantilla editable para estudios de arquitectura con portafolio, servicios, proceso, equipo, testimonios y formulario de consulta.",
        ...
        servicesCopy: "Edita especialidades, proyectos, proceso creativo y llamados a la acción para presentar un estudio de arquitectura con autoridad visual.",
        proofTitle: "Confianza para proyectos de alto valor",
        proofCopy: "Usa testimonios, métricas y casos destacados para reducir fricción y convertir consultas en proyectos.",
    }),
    contabilidad: createPublicPageTree({
        id: "contabilidad",
        badge: "Contabilidad · SAT, IMSS, fiscal y planes",
        title: "Despacho Contable & Fiscal",
        copy: "Plantilla editable para despachos contables con servicios fiscales, planes, equipo, proceso, testimonios y diagnóstico gratuito.",
        ...
        servicesCopy: "Ajusta planes, obligaciones, beneficios y mensajes comerciales para convertir empresas en clientes recurrentes.",
        proofTitle: "Credibilidad financiera",
        proofCopy: "Presenta certificaciones, testimonios y proceso de trabajo para generar confianza desde la primera visita.",
    }),
    viajes: createPublicPageTree({
        id: "viajes",
        badge: "Viajes · paquetes, destinos y cotización",
        title: "Agencia de Viajes Premium",
        copy: "Plantilla editable para agencias de viajes con paquetes, destinos, asesores, proceso de reservación, testimonios y cotizador.",
        ...
        servicesCopy: "Modifica destinos, precios, categorías de viaje y formularios para captar solicitudes calificadas.",
        proofTitle: "Experiencias que venden",
        proofCopy: "Usa reseñas y pruebas visuales para convertir visitantes en viajeros listos para reservar.",
    }),
    notaria: createPublicPageTree({
        id: "notaria",
        badge: "Notaría · trámites, tarifas y citas",
        title: "Notaría Pública",
        copy: "Plantilla editable para notarías con trámites, tarifas orientativas, equipo jurídico, proceso, testimonios y formulario de cita.",
        ...
        servicesCopy: "Edita procesos, requisitos, tiempos y formularios para facilitar la decisión del cliente.",
        proofTitle: "Autoridad jurídica",
        proofCopy: "Comunica experiencia, formalidad y confianza con una composición sobria y profesional.",
    }),
    rrhh: createPublicPageTree({
        id: "rrhh",
        badge: "RRHH · talento, cultura y consultoría",
        title: "Consultora de RRHH",
        copy: "Plantilla editable para consultoras de recursos humanos con servicios, casos de éxito, metodología, equipo y diagnóstico gratuito.",
        ...
        servicesCopy: "Ajusta reclutamiento, capacitación, cultura y métricas para presentar una consultoría clara y confiable.",
        proofTitle: "Resultados medibles",
        proofCopy: "Muestra casos, indicadores y testimonios para convertir interés en reuniones comerciales.",
    }),
    restaurante: createPublicPageTree({
        id: "restaurante",
        badge: "Gastronomía premium · reservas, menú y experiencia",
        title: "Restaurante Gourmet Pro",
        copy: "Plantilla editable para restaurantes de alta cocina con narrativa de marca, menú destacado, reservas, reseñas y secciones listas para convertir visitantes en comensales.",
        ...
        servicesCopy: "Edita servicios, especialidades, menús, horarios y mensajes comerciales sin tocar código. La estructura está lista para una operación gastronómica real.",
        proofTitle: "Prueba social para generar confianza",
        proofCopy: "Usa testimonios, reseñas y mensajes de autoridad para reforzar reputación y aumentar conversiones desde la primera visita.",
    }),
    clinica: createPublicPageTree({
        id: "clinica",
        badge: "Healthcare · especialidades, doctores y cita online",
        title: "Clínica & Salud Digital",
        copy: "Plantilla editable para clínicas, consultorios y centros médicos con secciones para especialidades, proceso de atención, seguros, doctores y solicitud de cita.",
        ...
        servicesCopy: "Ajusta especialidades, beneficios, seguros aceptados y llamadas a la acción para convertir tráfico en citas confirmadas.",
        proofTitle: "Confianza clínica desde el diseño",
        proofCopy: "Presenta evidencia, testimonios y credenciales con una composición profesional pensada para servicios de salud.",
    }),
    inmobiliaria: createPublicPageTree({
        id: "inmobiliaria",
        badge: "Real estate · propiedades, agentes y captación",
        title: "Inmobiliaria Premium",
        copy: "Plantilla editable para inmobiliarias y brokers con hero de lujo, propiedades destacadas, valoración gratuita, agentes, proceso comercial y reporte de mercado.",
        ...
        servicesCopy: "Modifica zonas, tipos de propiedad, argumentos de venta y llamados para captar compradores, vendedores o inversionistas.",
        proofTitle: "Autoridad para decisiones de alto valor",
        proofCopy: "Comunica experiencia, reputación y resultados con secciones pensadas para mercados inmobiliarios competitivos.",
    }),
    agencia: createPublicPageTree({
        id: "agencia",
        badge: "Agencia digital · servicios, casos y conversión",
        title: "Agencia Digital 360",
        copy: "Plantilla editable para estudios creativos y agencias de marketing con servicios, casos de éxito, proceso, planes, equipo y formulario de contacto.",
        ...
        servicesCopy: "Adapta la oferta, métricas, proceso y mensajes de venta para presentar una agencia moderna y orientada a resultados.",
        proofTitle: "Casos, confianza y cierre comercial",
        proofCopy: "Usa testimonios y bloques de prueba social para convertir interés en reuniones calificadas.",
    }),
    academia: createPublicPageTree({
        id: "academia",
        badge: "EdTech · cursos, rutas e instructores",
        title: "Academia EdTech Pro",
        copy: "Plantilla editable para academias, cursos y plataformas de formación con catálogo, rutas de aprendizaje, instructores, precios y testimonios.",
        ...
        servicesCopy: "Edita cursos, beneficios, rutas, instructores y planes para lanzar una academia con narrativa clara y conversiones medibles.",
        proofTitle: "Aprendizaje con prueba social",
        proofCopy: "Presenta resultados, comunidad e instructores para reducir fricción y aumentar inscripciones.",
    }),
    abogados: createPublicPageTree({
        id: "abogados",
        badge: "Derecho · laboral, mercantil, familiar, penal",
        title: "Despacho Jurídico Pro",
        copy: "Plantilla editable para despachos de abogados y firmas legales con áreas de práctica, equipo, proceso, testimonios y formulario de consulta gratuita.",
        ...
        servicesCopy: "Edita especialidades jurídicas, equipo de abogados, proceso y argumentos de autoridad para presentar un despacho confiable y con credibilidad comprobable.",
        proofTitle: "Testimonios y casos ganados",
        proofCopy: "Usa reseñas verificadas y casos de éxito para reducir la fricción del cliente y posicionarte como la mejor opción legal en tu área.",
    }),
    gimnasio: createPublicPageTree({
        id: "gimnasio",
        badge: "Fitness · clases, membresías y entrenadores",
        title: "Gimnasio & Fitness Pro",
        copy: "Plantilla editable para gimnasios, boxes de CrossFit y centros de bienestar con clases, horarios, membresías, entrenadores, testimonios y formulario de prueba gratis.",
        ...
        servicesCopy: "Edita disciplinas, horario semanal, membresías y precios para lanzar o escalar un gimnasio con una narrativa orientada a resultados y conversiones.",
        proofTitle: "Resultados que convencen",
        proofCopy: "Presenta testimonios reales, transformaciones y estadísticas del gimnasio para reducir la fricción del prospecto y acelerar la toma de decisión.",
    }),
    barberia: createPublicPageTree({
        id: "barberia",
        badge: "Barbería · cortes, barba, reservas y galería",
        title: "Barbería Premium",
        copy: "Plantilla editable para barberías y peluquerías con servicios y precios, galería de trabajos, equipo de barberos, sistema de reservas y reseñas de clientes.",
        ...
        servicesCopy: "Adapta la carta de servicios, precios, barberos y horarios para presentar una barbería con identidad propia y flujo de reservas optimizado.",
        proofTitle: "Galería y reputación",
        proofCopy: "Muestra el portfolio de trabajos y reseñas de clientes para construir la reputación que convierte visitantes en clientes recurrentes.",
    }),
    hotel: createPublicPageTree({
        id: "hotel",
        badge: "Hospitalidad · habitaciones, spa y reservas",
        title: "Hotel Boutique Luxury",
        copy: "Plantilla editable para hoteles boutique y posadas de lujo con habitaciones, servicios, galería, reseñas de huéspedes y formulario de reserva directa.",
        ...
        servicesCopy: "Edita tipos de habitación, precios por noche, servicios del hotel y disponibilidad para presentar una propiedad boutique que convierte visitas en reservas directas.",
        proofTitle: "Reseñas que generan confianza",
        proofCopy: "Presenta valoraciones reales de huéspedes para construir autoridad y posicionar el hotel como la mejor opción en su mercado de lujo.",
    }),
    transporte: createPublicPageTree({
        id: "transporte",
        badge: "Transporte · ejecutivo, aeropuerto y eventos",
        title: "Transporte Ejecutivo Pro",
        copy: "Plantilla editable para empresas de transporte ejecutivo con servicios, flotilla, zonas de cobertura, tarifas, formulario de cotización y testimonios corporativos.",
        ...
        servicesCopy: "Adapta la oferta de traslados, vehículos disponibles, zonas de cobertura y paquetes para posicionar una empresa de transporte premium y captar clientes corporativos.",
        proofTitle: "Confianza corporativa comprobable",
        proofCopy: "Usa testimonios de empresas y particulares para demostrar puntualidad, profesionalismo y convertir cotizaciones en contratos recurrentes.",
    }),
};
function getEditorTreeForWeb(id) {
    return exports.WEB_EDITOR_TREES[id];
}
exports.DEFAULT_STARTER_WEB_ID = "servicios-locales";
function getDefaultStarterEditorTree() {
    return (0, starterTree_1.buildRichStarterTree)();
}
