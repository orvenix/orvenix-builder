...
exports.validateHtmlExport = validateHtmlExport;
function countMatches(input, pattern) {
    var _a, _b;
    return (_b = (_a = input.match(pattern)) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0;
}
...
function validateHtmlExport(html) {
    const issues = [];
