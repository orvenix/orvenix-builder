...
export const testimonials: Testimonial[] = [
  ...
  { id: 4, name: "Carlos Ruiz",    role: "CEO",               company: "NovaCloud",       initials: "CR", colorKey: "amber",   rating: 5, metric: "+340% ROI en 6 meses",          text: "El soporte es excepcional. Nuestro CSM conoce nuestro negocio mejor que algunos de nuestros propios empleados. ROI positivo desde el primer mes." },
...
export const brands = ["Stripe", "NovaCloud", "Linear", "Notion", "Figma", "Shopify"]
