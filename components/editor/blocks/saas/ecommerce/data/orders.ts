...
export const orders: Order[] = [
  ...
  { id: "#ORD-8818", customer: "Carlos R.", email: "carlos@novacloud.example",product: "4K Portable Monitor",    amount: "$349", status: "refunded",   date: "Ayer, 18:22",  initials: "CR", colorKey: "amber"   },
