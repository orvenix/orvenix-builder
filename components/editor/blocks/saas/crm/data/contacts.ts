...
export const contacts: Contact[] = [
  ...
  { id: 4, name: "Carlos Ruiz",    company: "NovaCloud",       role: "CEO",                email: "carlos@novacloud.example",status: "Negociación",  score: 91, deal: "$380K", lastContact: "Hace 3d",  initials: "CR", colorKey: "amber",  starred: true  },
