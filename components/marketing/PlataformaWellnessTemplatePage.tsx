...
import type { PlataformaWellnessTemplate } from "@/lib/plataformaWellnessTemplates";

export function PlataformaWellnessTemplatePage({
  template,
}: {
  template: PlataformaWellnessTemplate;
}) {
  return (
    <MarketingLayout>
        ...
        <div className="mk-container grid min-h-[72vh] items-center gap-12 py-20 lg:grid-cols-[1fr_420px]">
          ...
          <div className="mk-glass-card p-6">
            <div className="mb-5 border-b border-white/8 pb-4">
              ...
              <div className="mt-2 text-sm leading-7 text-orvenix-secondary">{template.cardSummary}</div>
            </div>
