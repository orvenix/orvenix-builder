...
const items = [
  ...
  { badge: 'Analítica', title: 'DataPulse', desc: 'Plan Business · Panel centralizado para reportes a 12 clientes corporativos. Cero correos de adjuntos.', img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80&auto=format&fit=crop', alt: 'DataPulse — Analítica usando Orvenix' },
  ...
  { badge: 'Fitness', title: 'FitCoach Pro', desc: 'Plan Starter → Pro · Gestiona rutinas y pagos de 60 alumnos. Creció x3 en 6 meses con la plataforma.', img: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&q=80&auto=format&fit=crop', alt: 'FitCoach Pro — Entrenadores usando Orvenix' },
  ...
  { badge: 'Agencia', title: 'Lumina Studio', desc: 'Plan Business · Entrega de proyectos creativos a clientes vía portal privado. NPS aumentó a 92.', img: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=800&q=80&auto=format&fit=crop', alt: 'Lumina Studio — Agencia en Orvenix' },
  { badge: 'Logística', title: 'SwiftLog', desc: 'Plan Business · Tracking de envíos y documentación compartida con 30 clientes en tiempo real.', img: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80&auto=format&fit=crop', alt: 'SwiftLog — Logística en Orvenix' },
