...
const testimonials = [
  ...
  { text: '"Empecé con el plan Starter y en 3 meses escalé al Pro. La plataforma creció conmigo. Mis alumnos ahora tienen su propio portal y la deserción bajó un 40%."', name: 'Luis Camacho', role: 'Founder · FitCoach Pro', initials: 'LC', avatarClass: 'bg-orvenix-accent-3' },
  ...
  { text: '"Activamos Pro y ahorramos mas que la suscripcion solo en tiempo administrativo. El ROI fue inmediato. Es la mejor inversion que hice para mi negocio este año."', name: 'Ricardo Silva', role: 'Gerente · SwiftLog', initials: 'RS', avatarClass: 'bg-orvenix-accent-2' },
];
