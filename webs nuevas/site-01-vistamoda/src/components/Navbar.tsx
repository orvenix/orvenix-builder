...
const navLinks = [
  ...
  { href: '/tienda?cat=mujer', label: 'Mujer' },
  { href: '/tienda?cat=hombre', label: 'Hombre' },
    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/carrito" className="relative p-2 text-gray-700 hover:text-brand-600 transition-colors">
              <ShoppingBag size={22} />
      ...
      {open && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 py-4 space-y-3">
          ...
          <Link href="/contacto" onClick={() => setOpen(false)} className="block text-gray-700 font-medium py-2 hover:text-brand-600">
            Contacto
          </Link>
        </div>
      )}
