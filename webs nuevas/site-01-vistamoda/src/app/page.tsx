        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-xl">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              ...
              <Link href="/tienda?cat=oferta" className="border-2 border-white text-white hover:bg-white hover:text-dark font-semibold px-8 py-4 rounded-lg transition-all duration-200 inline-flex items-center gap-2">
                Ver ofertas
              </Link>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link href="/tienda" className="hidden md:flex items-center gap-2 text-brand-600 font-semibold hover:gap-3 transition-all">
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-brand-600/80 flex items-center">
              <div className="max-w-7xl mx-auto px-8 md:px-16">
                ...
                <Link href="/tienda?cat=accesorios" className="btn-dark">
