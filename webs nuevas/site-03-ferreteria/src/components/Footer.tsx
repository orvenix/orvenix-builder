        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="p-2 bg-gray-800 rounded-lg hover:bg-brand-600 transition-colors"><Facebook size={15} /></a>
              <a href="#" className="p-2 bg-gray-800 rounded-lg hover:bg-brand-600 transition-colors"><Instagram size={15} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['Herramientas manuales', 'Herramientas eléctricas', 'Materiales de obra', 'Pinturas y barnices', 'Plomería', 'Electricidad'].map(item => (
                <li key={item}><Link href="/catalogo" className="hover:text-brand-400 transition-colors">{item}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['Corte de materiales', 'Asesoramiento técnico', 'Entrega a domicilio', 'Crédito para empresas', 'Presupuestos de obra'].map(item => (
                <li key={item}><Link href="/servicios" className="hover:text-brand-400 transition-colors">{item}</Link></li>
              ))}
            </ul>
          </div>
