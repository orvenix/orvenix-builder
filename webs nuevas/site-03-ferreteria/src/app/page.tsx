      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link href="/catalogo" className="hidden md:flex items-center gap-1 text-brand-600 font-semibold text-sm hover:gap-2 transition-all">
              Ver todo <ChevronRight size={16} />
            </Link>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categorias.map(cat => (
              <Link key={cat.slug} href={`/catalogo/${cat.slug}`} className="group text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-dark rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
              ...
              <Link href="/contacto" className="border-2 border-white/30 text-white hover:bg-white/10 font-bold px-6 py-3 rounded-lg transition-all inline-flex items-center gap-2">
