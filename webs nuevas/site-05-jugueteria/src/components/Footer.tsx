        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="p-2 bg-gray-800 rounded-lg hover:bg-blue-600 transition-colors"><Instagram size={14} /></a>
              <a href="#" className="p-2 bg-gray-800 rounded-lg hover:bg-blue-600 transition-colors"><Facebook size={14} /></a>
              <a href="#" className="p-2 bg-gray-800 rounded-lg hover:bg-red-600 transition-colors"><Youtube size={14} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['0–1 año', '1–3 años', '4–6 años', '7–10 años', '11–14 años'].map(e => (
                <li key={e}><Link href="/catalogo" className="hover:text-blue-400 transition-colors">{e}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['Peluches', 'Juegos de mesa', 'Educativos', 'Acción y aventura', 'Arte y manualidades', 'Vehículos'].map(c => (
                <li key={c}><Link href="/catalogo" className="hover:text-blue-400 transition-colors">{c}</Link></li>
              ))}
            </ul>
          </div>
